                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="category" name="category"
                                                placeholder="Enter name of category" autocomplete="off" value="{{ $categories->category_name }}" />
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="dateupdate" class="lbl mb-2">Updated at</label>
                                            <input type="datetime-local" id="dateupdate" name="dateupdate" class="form-control">

                                            @if (count($errors) > 0)
                                                <div style="width: auto; color:red; margin-top:0.25rem;">
                                                    {{ $errors->first('dateupdate') }}
                                                </div>
                                            @endif
                                        </div>
                                    </div>
